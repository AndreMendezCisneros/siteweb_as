...
export const quy: Dict = {
  ...
  site: {
    ...
    definition:
      "Asiscoleqa RYJEC-pa tecnología plataformanmi yachay wasikunata kamachinanpaq, digitalizaciónpaq.",
    promise:
  ...
  cta: {
    ...
    bandTitle: "¿Asiscoleta yachay wasiykiman apamusunchik?",
    bandDescription:
      "Instalación, capacitacion wan carnets personalizadospi yanapasayki. 30 p'unchaw gratis pruebawan qallariy.",
  },
  announcement: {
    text: "Asiscoleta yachay wasiykiman churay · gratis prueba 30 p'unchaw",
  ...
  ui: {
    ...
    mockCaption: "Asiscole panelpa cheqaq vista",
    notFound: {
      code: "404",
  ...
  modules: [
    ...
    },
    {
      ...
      description:
        "Asiscole aplicativo mensajería: yachay wasi familiakunawan rimanakuynin historialwan, claro roleswan.",
      benefits: [
  ...
  institutions: [
    {
      ...
      status: "Producciónpi",
      description: "Asiscolewanña asistencia incidenciakunata kamachiq yachay wasi.",
    ...
    },
    {
      ...
      location: "Ayacucho-Huamanga",
      status: "Producciónpi",
      description: "Asiscolewanña producciónpi llamkaq yachay wasi.",
  ...
  methodology: [
    ...
    },
    {
      ...
      title: "Ruway",
      description:
        "Asiscoleta configuranchik, rolman hina usuarios wan institucional marcayuq carnets.",
    },
    {
      step: "05",
      title: "Yanapay",
  ...
  faq: [
    {
      ...
      a: "Asiscoleqa punku control, incidencias wan familiakunawan comunicación necesitachkaq yachay wasikunapaqmi. Kunanqa Ayacucho-Huamanga colegiospi llamkan.",
    },
    {
    ...
    },
    {
      ...
      a: "Tayta-mama portalwan wan Asiscole aplicativo mensajeríawan. WhatsApp 949 261 503qa comercial / demo canalllam.",
    },
    {
      q: "¿Pagos notaswanmi?",
  ...
  productVisuals: {
    ...
    galleryTitle: "Asiscoleqa ukhunpi kayhina rikurin",
    galleryDescription:
    ...
    carnetAlt: "Asiscole carnet ejemplo",
    carnetPoints: [
  ...
  personalization: {
    ...
    description:
      "Asiscoleqa manam huklla uyata forzanchu. Colores, logo, carnets wan pantallakunata instituciónman adaptanchik: plataformaqa ñawpaq p'unchawmantaraq qampa hina.",
    features: [
    ...
    examples: [
      ...
      {
        name: "Liceo Aurora",
        vibe: "Asiscole morado + tecnológico celeste; gradiente carnets.",
        accent: "#5b21e6",
      },
    ],
  ...
  home: {
    ...
    problemDescription:
      "Asistencia papelpi kachkaptin comunicación improvisado chatkunapi kachkaptin, direcciónqa tarde decidin. Asiscoleqa tukuyta rolman hina yaykuywan hukllapi churan.",
    ...
    audiencesTitle: "Pipaqmi Asiscole",
    ...
    institutionsEyebrow: "Asiscoletaña llamkachinku",
  ...
  pages: {
    plataforma: {
      ...
      metaDescription:
        "Asiscole: yachay wasipa operativo base — asistencia, incidencias, carnets, portal wan mensajería.",
    ...
    modulos: {
      ...
      metaDescription: "Asiscole módulos catálogo: kachkanña wan hamunraq.",
    ...
    comoFunciona: {
      ...
      metaDescription: "Asiscole implementación: gratis pruebamanta yachay wasi wiñaykama.",
      heroEyebrow: "Imaynataq llamkan",
      heroTitle: "Pilotomanta wiñaq plataformakama",
      heroDescription:
        "Asiscoleta yachay wasi llamkayta mana sayachiychu churanapaq claro procesowan llamkanchik.",
    },
    instituciones: {
      metaTitle: "Yachay wasikuna",
      metaDescription: "Asiscoleta producciónpiña llamkachiq yachay wasikuna.",
      heroEyebrow: "Yachay wasikuna",
      heroTitle: "Asiscolepi confiaq yachay wasikuna",
      heroDescription:
        "Ayacucho-Huamanga colegios asistencia incidenciakunata plataformawanña kamachinku.",
    },
    planes: {
      metaTitle: "Planekuna",
      metaDescription: "Asiscole planekuna configurables. Mana inventasqa precios.",
    ...
    nosotros: {
      metaTitle: "Ñuqanchik",
      metaDescription: "Asiscoleqa Ayacuchopi paqarisqa RYJEC marca.",
      heroEyebrow: "Ñuqanchik",
      heroTitle: "Yachay wasipaq allin tecnología, RYJEC-pa ruwasqan",
      heroDescription:
        "Asiscoleqa Ayacuchopi paqarin planillakunata improvisado chatkunata reemplazanapaq: huklla cheqaq willakuy, rolman hina yaykuywan.",
    ...
    contacto: {
      metaTitle: "Rimanakuy",
      metaDescription: "Asiscole gratis pruebaykita mañakuy. WhatsApp 949 261 503.",
    ...
    legalPrivacidad: {
      ...
      intro:
        "Asiscole (RYJEC marca) privacidadniykita respetan. Kay políticaqa formulario utaq correowan apachisqa datos personales tratamientota willan.",
      sections: [
        {
          heading: "Responsable",
    ...
    legalTerminos: {
      ...
      heroDescription: "asiscole.com sitio uso condiciones.",
      intro:
      ...
      sections: [
        ...
        },
        {
          ...
          body: "WhatsApp 949 261 503qa comercial canalmi. Familikunawan operativo canalqa Asiscole portal mensajeríam.",
        },
      ],
      updated: "Qhipa actualización: agosto 2026.",
    },
    legalCookies: {
      ...
      heroDescription: "asiscole.com-pi cookies uso.",
      intro:
    ...
    legalReclamaciones: {
      ...
      heroDescription: "Asiscolewan relacionasqa reclamos canal.",
      intro:
        "Asiscole serviciowan relacionasqa reclamota apachinaykipaq, contacto@ryjec.com-man qillqawayku: datoykikuna, reclamado hecho wan mañakuyniyki.",
      sections: [
        {
          heading: "Kutichiy",
  ...
  whatsappFloat: {
    ...
    message:
      "Napaykullayki Asiscole, yachay wasiypaq 30 p'unchaw gratis pruebata mañakuyta munani.",
  },
};
