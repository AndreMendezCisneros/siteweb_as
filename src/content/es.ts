export const es = {
  ...
  site: {
    ...
    definition:
      "Asiscole es una plataforma tecnológica de RYJEC para la gestión y digitalización de instituciones educativas.",
    promise: "Tecnología útil para el colegio: una sola fuente de verdad, con accesos por rol.",
    url: "https://asiscole.com",
    ogLocale: "es_PE",
    parentBrand: "RYJEC",
    emails: {
  ...
  ui: {
    ...
    mockCaption: "Vista real del panel Asiscole",
    notFound: {
      code: "404",
  ...
  modules: [
    ...
    },
    {
      ...
      description:
        "Mensajería en el aplicativo Asiscole para que el colegio y las familias se comuniquen con historial y roles claros.",
      benefits: [
  ...
  institutions: [
    {
      ...
      description: "Colegio que ya gestiona asistencia e incidencias con Asiscole.",
      href: "https://sanramon.asiscole.com",
    },
    {
      slug: "jean-piaget",
      ...
      location: "Ayacucho-Huamanga",
      status: "En producción",
      description: "Colegio que ya opera con Asiscole en producción.",
      href: "https://jeanpiaget.asiscole.com",
    },
  ],
  plans: [
    {
  ...
  methodology: [
    ...
    },
    {
      step: "04",
      title: "Construir",
      description: "Configuramos Asiscole, usuarios por rol y carnets con la marca institucional.",
    },
    {
      step: "05",
      title: "Acompañar",
  ...
  faq: [
    {
      ...
      a: "Asiscole está pensado para instituciones educativas que necesitan control de puerta, incidencias y comunicación con familias. Hoy opera en colegios de Ayacucho-Huamanga.",
    },
    {
    ...
    },
    {
      ...
      a: "Por el portal de padres y la mensajería del aplicativo Asiscole. WhatsApp 949 261 503 es solo canal comercial / demo.",
    },
    {
  ...
  productVisuals: {
    ...
    galleryTitle: "Así se ve Asiscole por dentro",
    galleryDescription:
    ...
    heroAlt: "Panel de inicio Asiscole",
    screens: [
    ...
    carnetAlt: "Ejemplo de carnet Asiscole",
    carnetPoints: [
  ...
  personalization: {
    ...
    description:
      "Asiscole no impone una sola cara. Adaptamos colores, logo, carnets y pantallas a la institución: la plataforma se siente tuya desde el primer día.",
    features: [
    ...
    examples: [
      ...
      {
        name: "Liceo Aurora",
        vibe: "Morado Asiscole + celeste tecnológico; carnets con gradiente de marca y foto circular.",
        accent: "#5b21e6",
      },
    ],
  ...
  home: {
    heroEyebrow: "Asiscole · RYJEC",
    problemEyebrow: "El problema y la propuesta",
    problemTitle: "De planillas dispersas a una sola fuente de verdad",
    problemDescription:
      "Cuando la asistencia vive en papel y la comunicación en chats improvisados, dirección decide tarde. Asiscole centraliza todo con accesos por rol.",
    ...
    audiencesTitle: "Para quién es Asiscole",
    ...
    institutionsEyebrow: "Ya usan Asiscole",
  ...
  pages: {
    plataforma: {
      ...
      metaDescription:
        "Asiscole: base operativa del colegio con asistencia, incidencias, carnets, portal y mensajería.",
    ...
    modulos: {
      metaTitle: "Módulos",
      metaDescription: "Catálogo de módulos Asiscole: disponibles y próximamente.",
      heroEyebrow: "Módulos",
    ...
    comoFunciona: {
      ...
      metaDescription: "Implementación Asiscole: de la prueba gratuita a la evolución del colegio.",
      heroEyebrow: "Cómo funciona",
      heroTitle: "Del piloto a una plataforma que crece",
      heroDescription:
        "Trabajamos con un proceso claro para implementar Asiscole sin detener la operación del colegio.",
    },
    instituciones: {
      metaTitle: "Instituciones",
      metaDescription: "Instituciones que ya usan Asiscole en producción.",
      heroEyebrow: "Instituciones",
      heroTitle: "Instituciones que confían en Asiscole",
      heroDescription:
        "Colegios en Ayacucho-Huamanga que ya gestionan asistencia e incidencias con la plataforma.",
    },
    planes: {
      metaTitle: "Planes",
      metaDescription: "Planes Asiscole configurables. Sin precios inventados.",
      heroEyebrow: "Planes",
    ...
    nosotros: {
      metaTitle: "Nosotros",
      metaDescription: "Asiscole es una marca de RYJEC nacida en Ayacucho.",
      heroEyebrow: "Nosotros",
      heroTitle: "Tecnología útil para el colegio, hecha por RYJEC",
      heroDescription:
        "Asiscole nace en Ayacucho para reemplazar planillas y chats improvisados: una sola fuente de verdad, con accesos por rol.",
    ...
    contacto: {
      metaTitle: "Contacto",
      metaDescription: "Solicita tu prueba gratuita de Asiscole. WhatsApp 949 261 503.",
    ...
    legalPrivacidad: {
      ...
      intro:
        "Asiscole (marca de RYJEC) respeta tu privacidad. Esta política describe el tratamiento de datos personales enviados por el formulario o por correo.",
      sections: [
        {
          heading: "Responsable",
    ...
    legalTerminos: {
      ...
      heroDescription: "Condiciones de uso del sitio asiscole.com.",
      intro:
      ...
      sections: [
        ...
        },
        {
          ...
          body: "WhatsApp 949 261 503 es canal comercial. El canal operativo con familias es el portal y la mensajería de Asiscole.",
        },
      ],
      updated: "Última actualización: agosto 2026.",
    },
    legalCookies: {
      ...
      heroDescription: "Uso de cookies en asiscole.com.",
      intro:
    ...
    legalReclamaciones: {
      ...
      heroDescription: "Canal para presentar reclamos relacionados con Asiscole.",
      intro:
        "Para presentar un reclamo relacionado con el servicio Asiscole, escríbenos a contacto@ryjec.com indicando tus datos, el hecho reclamado y tu pedido.",
      sections: [
        {
          heading: "Respuesta",
  ...
  whatsappFloat: {
    ...
    message: "Hola Asiscole, quiero solicitar la prueba gratuita de 30 días para mi colegio.",
  },
};
