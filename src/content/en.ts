...
export const en: Dict = {
  ...
  site: {
    ...
    definition:
      "Asiscole is a RYJEC technology platform for managing and digitizing educational institutions.",
  ...
  cta: {
    ...
    bandTitle: "Shall we bring Asiscole to your school?",
    bandDescription:
      "We support installation, training and branded ID cards. Start with a free 30-day trial.",
  },
  announcement: {
    text: "Implement Asiscole in your school · free 30-day trial",
  ...
  ui: {
    ...
    mockCaption: "Live Asiscole panel view",
    notFound: {
      code: "404",
  ...
  modules: [
    ...
    },
    {
      ...
      description:
        "Messaging in the Asiscole app so school and families communicate with clear history and roles.",
      benefits: [
  ...
  institutions: [
    {
      ...
      description: "A school already managing attendance and incidents with Asiscole.",
    ...
    },
    {
      ...
      location: "Ayacucho-Huamanga",
      status: "In production",
      description: "A school already operating Asiscole in production.",
  ...
  methodology: [
    ...
    },
    {
      step: "04",
      title: "Build",
      description: "We configure Asiscole, role-based users and branded ID cards.",
    },
    {
      step: "05",
      title: "Support",
  ...
  faq: [
    {
      ...
      a: "Asiscole is for educational institutions that need gate control, incidents and family communication. It currently operates in schools in Ayacucho-Huamanga.",
    },
    {
    ...
    },
    {
      ...
      a: "Through the parent portal and Asiscole app messaging. WhatsApp 949 261 503 is only a commercial / demo channel.",
    },
    {
  ...
  productVisuals: {
    ...
    galleryTitle: "This is Asiscole inside",
    galleryDescription:
    ...
    heroAlt: "Asiscole home dashboard",
    screens: [
    ...
    carnetAlt: "Asiscole student ID card example",
    carnetPoints: [
  ...
  personalization: {
    ...
    description:
      "Asiscole does not force a single look. We adapt colors, logo, ID cards and screens to the institution: the platform feels yours from day one.",
    features: [
    ...
    examples: [
      ...
      {
        name: "Liceo Aurora",
        vibe: "Asiscole purple + tech cyan; ID cards with brand gradient and circular photo.",
        accent: "#5b21e6",
      },
    ],
  ...
  home: {
    ...
    problemDescription:
      "When attendance lives on paper and communication in improvised chats, leadership decides late. Asiscole centralizes everything with role-based access.",
    ...
    audiencesTitle: "Who Asiscole is for",
    ...
    institutionsEyebrow: "Already using Asiscole",
  ...
  pages: {
    plataforma: {
      metaTitle: "Platform",
      metaDescription:
        "Asiscole: the school's operational base with attendance, incidents, ID cards, portal and messaging.",
    ...
    modulos: {
      metaTitle: "Modules",
      metaDescription: "Asiscole module catalog: available and coming soon.",
      heroEyebrow: "Modules",
    ...
    comoFunciona: {
      ...
      metaDescription: "Asiscole rollout: from free trial to school evolution.",
      heroEyebrow: "How it works",
      heroTitle: "From pilot to a platform that grows",
      heroDescription:
        "We work with a clear process to implement Asiscole without stopping school operations.",
    },
    instituciones: {
      metaTitle: "Institutions",
      metaDescription: "Institutions already using Asiscole in production.",
      heroEyebrow: "Institutions",
      heroTitle: "Institutions that trust Asiscole",
      heroDescription:
        "Schools in Ayacucho-Huamanga already managing attendance and incidents with the platform.",
    },
    planes: {
      metaTitle: "Plans",
      metaDescription: "Configurable Asiscole plans. No invented prices.",
      heroEyebrow: "Plans",
    ...
    nosotros: {
      metaTitle: "About us",
      metaDescription: "Asiscole is a RYJEC brand born in Ayacucho.",
      heroEyebrow: "About us",
      heroTitle: "Useful technology for schools, built by RYJEC",
      heroDescription:
        "Asiscole was born in Ayacucho to replace spreadsheets and improvised chats: one source of truth, with role-based access.",
    ...
    contacto: {
      metaTitle: "Contact",
      metaDescription: "Request your free Asiscole trial. WhatsApp 949 261 503.",
      heroEyebrow: "Contact",
    ...
    legalPrivacidad: {
      ...
      intro:
        "Asiscole (a RYJEC brand) respects your privacy. This policy describes the processing of personal data sent through the form or by email.",
      sections: [
        {
          heading: "Controller",
    ...
    legalTerminos: {
      ...
      heroDescription: "Terms of use for asiscole.com.",
      intro:
      ...
      sections: [
        ...
        },
        {
          ...
          body: "WhatsApp 949 261 503 is a commercial channel. The operational channel with families is the Asiscole portal and messaging.",
        },
      ],
      updated: "Last updated: August 2026.",
    },
    legalCookies: {
      ...
      heroDescription: "Cookie use on asiscole.com.",
      intro:
    ...
    legalReclamaciones: {
      ...
      heroDescription: "Channel to submit complaints related to Asiscole.",
      intro:
        "To submit a complaint related to the Asiscole service, write to contacto@ryjec.com with your details, the facts and your request.",
      sections: [
        {
          heading: "Response",
  ...
  whatsappFloat: {
    ...
    message: "Hello Asiscole, I want to request the free 30-day trial for my school.",
  },
};
